...
pub const SLAB_LEN: usize = 1156736; // MAX_ACCOUNTS=4096 + native 128-bit fields
...
pub fn encode_init_market_hyperp(admin: &Pubkey, mint: &Pubkey, initial_mark_price_e6: u64) -> Vec<u8> {
...
impl TestEnv {
    ...
    pub fn read_num_used_accounts(&self) -> u16 {
        ...
        pub const NUM_USED_OFFSET: usize = 520 + 1120;
    ...
    pub fn is_slot_used(&self, idx: u16) -> bool {
        ...
        pub const BITMAP_OFFSET: usize = 520 + 608;
    ...
    pub fn read_account_capital(&self, idx: u16) -> u128 {
        ...
        pub const ACCOUNTS_OFFSET: usize = 520 + 9336;
    ...
    pub fn read_account_position(&self, idx: u16) -> i128 {
        ...
        pub const ENGINE: usize = 520;
        pub const ACCOUNTS_OFFSET: usize = ENGINE + 9336;
        pub const ACCOUNT_SIZE: usize = 280;
        ...
        pub const SCALE_FACTOR: u128 = POS_SCALE / 1_000_000;
    ...
    pub fn read_update_config_snapshot(&self) -> (u64, u128, u64, u128, u128) {
        ...
        pub const FUNDING_HORIZON_OFF: usize = 184;
        pub const FUNDING_INV_SCALE_OFF: usize = 200;
        pub const THRESH_ALPHA_OFF: usize = 272;
        pub const THRESH_MIN_OFF: usize = 280;
        pub const THRESH_MAX_OFF: usize = 296;

        let funding_horizon = u64::from_le_bytes(
            slab_account.data[FUNDING_HORIZON_OFF..FUNDING_HORIZON_OFF + 8]
                .try_into()
                .unwrap(),
        );
        let funding_inv_scale = u128::from_le_bytes(
            slab_account.data[FUNDING_INV_SCALE_OFF..FUNDING_INV_SCALE_OFF + 16]
                .try_into()
                .unwrap(),
        );
        let thresh_alpha = u64::from_le_bytes(
            slab_account.data[THRESH_ALPHA_OFF..THRESH_ALPHA_OFF + 8]
                .try_into()
                .unwrap(),
        );
        let thresh_min = u128::from_le_bytes(
            slab_account.data[THRESH_MIN_OFF..THRESH_MIN_OFF + 16]
                .try_into()
                .unwrap(),
        );
        let thresh_max = u128::from_le_bytes(
            slab_account.data[THRESH_MAX_OFF..THRESH_MAX_OFF + 16]
                .try_into()
                .unwrap(),
        );
...
impl TestEnv {
    ...
    pub fn try_withdraw(&mut self, owner: &Keypair, user_idx: u16, amount: u64) -> Result<(), String> {
        let ata = self.create_ata(&owner.pubkey(), 0);
        let (vault_pda, _) =
            Pubkey::find_program_address(&[b"vault", self.slab.as_ref()], &self.program_id);
...
impl TestEnv {
    ...
    pub fn read_insurance_balance(&self) -> u128 {
        ...
        pub const INSURANCE_OFFSET: usize = 520 + 16;
        u128::from_le_bytes(
...
impl TradeCpiTestEnv {
    ...
    pub fn read_insurance_balance(&self) -> u128 {
        ...
        pub const INSURANCE_BALANCE_OFFSET: usize = 520 + 16;
        u128::from_le_bytes(
    ...
    pub fn read_pnl_pos_tot(&self) -> u128 {
        ...
        pub const PNL_POS_TOT_OFFSET: usize = 520 + 272;
        u128::from_le_bytes(
    ...
    pub fn read_c_tot(&self) -> u128 {
        ...
        pub const C_TOT_OFFSET: usize = 520 + 256;
        u128::from_le_bytes(
    ...
    pub fn read_vault(&self) -> u128 {
        ...
        pub const VAULT_OFFSET: usize = 520;
        u128::from_le_bytes(
...
impl TestEnv {
    ...
    pub fn try_deposit(&mut self, owner: &Keypair, user_idx: u16, amount: u64) -> Result<(), String> {
        let ata = self.create_ata(&owner.pubkey(), amount);
...
impl TestEnv {
    ...
    pub fn try_crank_with_panic(&mut self, signer: &Keypair, allow_panic: u8) -> Result<(), String> {
        let ix = Instruction {
            program_id: self.program_id,
            accounts: vec![
                AccountMeta::new(signer.pubkey(), true),
...
impl TestEnv {
    ...
    pub fn try_deposit_to_idx(&mut self, owner: &Keypair, idx: u16, amount: u64) -> Result<(), String> {
        let ata = self.create_ata(&owner.pubkey(), amount);
...
impl TestEnv {
    ...
    pub fn read_insurance_floor(&self) -> u128 {
        ...
        pub const INSURANCE_FLOOR_OFFSET: usize = 520 + 608 - 16;
        u128::from_le_bytes(
